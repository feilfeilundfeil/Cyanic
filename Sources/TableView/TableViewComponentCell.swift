...
/**
 The TableViewComponentCell serves as the root UIView for the UI elements generated by its Layout
 */
open class TableViewComponentCell: UITableViewCell {

    /**
     The String identifier used by the TableViewComponentCell to register to a UICollectionView instance
     */
    ...
    // MARK: Layout
    /**
     The current ComponentLayout instance that created and arranged the subviews in the contentView of this TableViewComponentCell.
     */
